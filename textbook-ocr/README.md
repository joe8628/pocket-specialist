...
HuggingFace models (UniMERNet, TATR) are downloaded automatically on first run.
...
# Stage 3: layout detection + equation OCR + table structure
python3 cli.py equations --start-page 1 --end-page 50

# Stage 4: LLM correction (vision-language model)
